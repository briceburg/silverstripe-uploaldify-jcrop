		...
		<% control Files %>
			<li id="file-{$ID}" class="uploadifyFile clr">
				...
				<div class="delete">
					...
					<a href="#" class="jqmTrigger" rel="jcrop-{$ID}">Crop</a>
				...
				<div class="jqmWindow" id="jcrop-{$ID}">
					<img src="$URL" data-aspectratio="{$Top.AspectRatio}" />
					<br />
					<div class="uploadify-jcrop-actions">
						<a href="<% control Top %>$Link(cropfile)<% end_control %>" rel="$ID" class="uploadify-jcrop">Crop</a> &nbsp; <a href="#" class="jqmClose">Cancel</a>
					</div>
				</div>
